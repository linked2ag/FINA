...
'year.hintTerm':{en:'The “End” cell shows the remaining term including the current month:',
  de:'Die Zelle „Ende" zeigt die Restlaufzeit einschließlich des laufenden Monats:'},
...
'set.banksSub':{en:'The code appears in the year overview in columns B and Z, the label below each item in the month view. Both lists are yours alone — name them the way you think of your accounts. Change a code later and FINA asks whether the items that carry it should be moved along.',
  de:'Das Kürzel steht in der Jahresübersicht in den Spalten B und Z, die Bezeichnung unter jedem Posten der Monatsansicht. Beide Listen gehören dir allein — benenne sie so, wie du an deine Konten denkst. Änderst du später ein Kürzel, fragt FINA, ob die Posten mit diesem Kürzel mitwandern sollen.'},
